...
def extract(school_code, lower_limit, upper_limit):
    ...
    try:
        ...
        urls = ['http://cbseresults.nic.in/class12/cbse1216.asp?regno={}&schcode={}&B1=Submit'.format(rollno, school_code) for rollno in range(lower_limit, upper_limit + 1)]
        #print(urls)
        ...
        for page_source in page_sources:
            ...
            #page_source = grequests.get('http://cbseresults.nic.in/class12/cbse1216.asp', params=params, headers=headers).text
